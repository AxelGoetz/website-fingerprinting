...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{stacked_autoencoder}
...
Keras, on the other hand, uses either Tensorflow or Theano as a back-end.
...
The largest ones are the one used by Wang et al. \cite{wang_cai_johnson_nithyanand_goldberg_2014} and -todo: include who's.
