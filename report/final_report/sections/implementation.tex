...
\subsubsection{Data Collection} \label{sec:data_collection1}
...
\subsubsection{Fingerprint Extraction Training} \label{sec:fingerprint-extraction-training}
...
\subsubsection{Classifier Training} \label{sec:classifier-training}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\textwidth]{kfold}
...
Rather than using another classifier, we could also potentially add a \textit{softmax layer} on top of our decoder, like V. Rimmer uses on top of her stacked autoencoder \cite{deeplearningthesis}.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\textwidth]{softmax}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\textwidth]{code-structure}
